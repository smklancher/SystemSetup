...
function FinalSteps {
    # change locations that default to OneDrive, and unpin from quick access
    New-Item -Path "$env:USERPROFILE\Desktop" -ItemType directory -Force
    Set-KnownFolderPath -KnownFolder 'Desktop' -Path "$env:USERPROFILE\Desktop"
    & "$localPath\scripts\Set-QuickAccess.ps1" -Action Unpin -Path "C:\Users\smkni\Desktop"
...
.PARAMETER Path
    The path.
.LINK
https://stackoverflow.com/a/25709702/221018
